...
-- AddForeignKey
ALTER TABLE "UserApiLimit" ADD CONSTRAINT "UserApiLimit_userId_fkey" FOREIGN KEY ("userId") REFERENCES "UserSubscription"("id") ON DELETE CASCADE ON UPDATE CASCADE;
